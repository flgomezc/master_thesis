...
#SBATCH --job-name=Vcirmax150            #Nombre del job
...
#SBATCH --mem-per-cpu=4048		#Memoria en Mb por CPU, Default=2048
...
#SBATCH -o Vcircmax_150_.o%j.LOG	#Nombre de archivo de salida
...
make main_sequence FILENUM=150
