...
parser.add_argument('rcfilein', type=str)
parser.add_argument('fcfilein', type=str)
parser.add_argument('bskfilein', type=str)
parser.add_argument('mlfileout', type=str)
...
RC_FILE_IN = arg.rcfilein
FC_FILE_IN = arg.fcfilein
BSK_FILE_IN= arg.bskfilein
ML_FILE_OUT= arg.mlfileout
...
prog = "progress_{}.txt".format(ML_FILE_OUT)
...
RC_filename = "{}.cat".format(RC_FILE_IN)
FC_filename = "{}.cat".format(FC_FILE_IN)
BS_filename = "{}.BSKIndex".format(BSK_FILE_IN)
ML_filename = "{}.mls".format(ML_FILE_OUT)
...
subp.run( "echo MasterList {}, beta {}, n_rand {}, voids found in {} seconds. >> {}".format(ML_FILE_OUT, beta, n_rand, tic-toc, prog), shell=True, check=True)
