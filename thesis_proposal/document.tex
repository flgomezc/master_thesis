...
conforman los vac\'ios que nos interesan en esta tesis.
  ...
  \bigskip
  \textbf{Hace falta una imagen de algun paper que muestre los vacios dentro de las simulaciones}
  \bigskip
  ...
  \citet{https://arxiv.org/pdf/astro-ph/0610520.pdf} demuestran cómo la elipticidad de los vacíos
  ...
  La proporción de estos cambia con los parámetros
  cosmológicos que se utilicen de fondo.

  En ambos estudios se determina la validez de los métodos realizando la estadística de poblaciones
  de vacíos de la red en simulaciones con distintas condiciones iniciales.


  \citet{https://arxiv.org/pdf/1205.4238.pdf} Desarrollo completo.
...
\bigskip
 ...
 % \url{Hamaus, N., Sutter, P. M., Lavaux, G., & Wandelt, B. D. "Testing cosmic geometry without dynamic distortions using voids". JCAP 12, 013, December (2014). https://arxiv.org/pdf/1409.3580.pdf}
  ...
  Se quieren obtener resultados similares al convertir observaciones de
