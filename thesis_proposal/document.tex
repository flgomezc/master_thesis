...
conforman los vac\'ios que nos interesan en esta tesis.
  ...
  brazos robóticos con fibra óptica para tomar el espectro de hasta 5,000 objetos
  ...
  \begin{figure}
    \plottwo{msnras0414-a.png}{msnras0414-b.png}
 ...
 \end{equation}
  ...
  modelos semianalíticos para generación de catálogos MOCS que son computacionalmente más rápidos.
    ...
    {\bf Uso de las simulaciones presentadas en este paper
 ...
 % \url{Hamaus, N., Sutter, P. M., Lavaux, G., & Wandelt, B. D. "Testing cosmic geometry without dynamic distortions using voids". JCAP 12, 013, December (2014). https://arxiv.org/pdf/1409.3580.pdf}
  ...
  \begin{figure}
    ...
    \caption{ Función de densidad de probabilidad de la elipticidad de los vacíos
      \citep{https://arxiv.org/pdf/0906.4101.pdf} \label{fig:expected_results}}
  \end{figure}
