...
### Create VolumeAndExcentricity directory
VE_path = "volume_and_excentricity/"
subp.run("mkdir -p " + VE_path, shell=True, check=True)
FG_path = "figures/"
subp.run("mkdir -p " + FG_path, shell=True, check=True)
...
#                                                               #
#################################################################
subp.run( "echo # Count, Beta, n_rand > 04_Excentricity_progress.txt", shell=True, check=True)

# debug
# for maxiCounter in range(Times):
for maxiCounter in range(0, Times):
    # debug
    #maxiCounter = 1
    ...
    if M > 0:
        ...
        FG_filename = "number_particles_per_void_cut_{}_nrand_{}_Beta_{}_.png".format(cut,
                                                                            n_rand[maxiCounter],
                                                                            beta[maxiCounter])
        ...
        VE_filename = "VolumeAndEcentricity_cut_{}_nrand_{}_Beta_{}_.vae".format(cut,
                                                                            n_rand[maxiCounter],
                                                                            beta[maxiCounter])
        ...
        with open(VE_path + VE_filename, "w") as file:
            ...
            for ID in Void_N_Particles[:,0]:
                ...
                if particles_void_N > 4:
                    ...
                    # debug
                    # print(r, V)
                    stats = "{}, {}, {}, {}, {}, {}, {} \n".format(ID, V, r, a, b, c, str_vectors)
                    file.write(stats)
    else:
        print("\n\n\t%%%%%%%%%%%%%%%%%%%%%%%%%%")
    ...
    subp.run( "echo {}, {}, {}, {} >> 04_Excentricity_progress.txt".format(maxiCounter, beta[maxiCounter], n_rand[maxiCounter], tic-toc), shell=True, check=True)
